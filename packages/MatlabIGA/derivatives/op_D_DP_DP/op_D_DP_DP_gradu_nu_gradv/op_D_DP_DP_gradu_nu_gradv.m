function varargout = op_D_DP_DP_gradu_nu_gradv(spu, spv, spg, msh, dCdP, d2CdP2, u, mat)

    % First order derivative
    dKdC = op_D_DC_gradu_nu_gradv(spu, spv, spg, msh, u, mat);
    % Second order derivative
    dKdCdC = op_D_DC_DC_gradu_nu_gradv(spu, spv, spg, msh, u, mat);
    ...
    elseif (nargout == 2)
        ...
        error ('op_D_DP_DP_gradu_nu_gradv: wrong number of output arguments')
    end
end
