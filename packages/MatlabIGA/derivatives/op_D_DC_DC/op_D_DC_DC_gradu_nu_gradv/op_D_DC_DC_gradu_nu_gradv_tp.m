...
function varargout = op_D_DC_DC_gradu_nu_gradv_tp(space1, space2, space3, msh, u, material)
  ...
  A = sptensor([],[],[space2.ndof, space1.ndof, space3.ndof, msh.ndim, space3.ndof, msh.ndim]);
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_D_DC_DC_gradu_nu_gradv(sp1_col, sp2_col, sp3_col, msh_col, u, material);
  end
