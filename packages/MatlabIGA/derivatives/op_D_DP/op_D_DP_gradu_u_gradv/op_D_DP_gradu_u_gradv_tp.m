function varargout = op_D_DP_gradu_u_gradv_tp(space1, space2, space3, msh, u, dCdP)
    ...
    rows = cell(msh.nel_dir(1), 1);
    cols = cell(msh.nel_dir(1), 1);
    ...
    for iel = 1:msh.nel_dir(1)
        ...
        [rows{iel}, cols{iel}, vals{iel}] = op_D_DP_gradu_u_gradv(sp1_col, sp2_col, sp3_col, msh_col, u, dCdP);
    end
