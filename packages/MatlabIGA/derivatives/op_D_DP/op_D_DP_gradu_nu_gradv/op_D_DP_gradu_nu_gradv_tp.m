function varargout = op_D_DP_gradu_nu_gradv_tp(space1, space2, space3, msh, dCdP, u, material)
    ...
    for iel = 1:msh.nel_dir(1)
        ...
        [ind{iel}, vals{iel}] = op_D_DP_gradu_nu_gradv(sp1_col, sp2_col, sp3_col, msh_col, dCdP, u, material);
    end
