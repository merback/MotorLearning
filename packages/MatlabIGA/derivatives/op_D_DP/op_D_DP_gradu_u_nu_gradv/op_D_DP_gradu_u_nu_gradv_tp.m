function varargout = op_D_DP_gradu_u_nu_gradv_tp(space1, space2, space3, msh, u, dCdP, material)
    ...
    for iel = 1:msh.nel_dir(1)
        ...
        [r{iel}, c{iel}, vals{iel}] = op_D_DP_gradu_u_nu_gradv(sp1_col, sp2_col, sp3_col, msh_col, u, dCdP, material);
    end
