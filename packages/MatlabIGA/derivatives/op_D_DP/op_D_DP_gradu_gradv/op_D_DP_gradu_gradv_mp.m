function dKdP = op_D_DP_gradu_gradv_mp(spu, spv, spg, msh, dCdP, coeff, patch_list)
  ...
  for iPatch = patch_list
    [ind, v] = op_D_DP_gradu_gradv_tp(spu.sp_patch{iPatch}, spv.sp_patch{iPatch}, spg.sp_patch{iPatch}, msh.msh_patch{iPatch}, dCdP(spg.gnum{iPatch},:,:), coeff);
